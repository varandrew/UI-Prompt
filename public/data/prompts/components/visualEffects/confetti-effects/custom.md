...
**可用变体**：
- **极简主义**：黑白简约纸屑，几何形状，注重留白
- **Material Design**：Google Material 色板，流畅动画，强调层级
- **新粗野主义**：大胆色块，高对比度，强烈视觉冲击
- **玻璃态**：半透明柔和纸屑，模糊效果，飘逸感
- **赛博朋克**：霓虹发光纸屑，未来感，强烈对比
...
Celebration and success feedback animations with multiple design styles
...
**Available Variants**:
- **Minimalism**: Black and white simple confetti, geometric shapes, emphasis on whitespace
- **Material Design**: Google Material color palette, smooth animations, emphasis on hierarchy
- **Neo-Brutalism**: Bold color blocks, high contrast, strong visual impact
- **Glassmorphism**: Semi-transparent soft confetti, blur effects, floating sensation
- **Cyberpunk**: Neon glowing confetti, futuristic, strong contrast
